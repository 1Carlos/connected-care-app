  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="page-header">
        <h1>FAQ</h1>
        <p class="lead">Frecuency Asked Questions.</p>
        <div class="jumbotron">
        ...
        <div class="">
          <h3>Import External File</h3></br>
          What type of file I can import?</br>
          What happens when the importing is truncated?</br>
          <h3>Program Reconciliation</h3></br>
          <h3>Case Managment</h3></br>
        </div>
	  </div>
