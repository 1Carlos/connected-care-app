      ...
      <div class="page-header">
        ...
        <div class="jumbotron">
			<center>
				...
				<p><a class="btn btn-primary btn-lg" href="run_reconciliation2.html" role="button">Starting Process</a></p>
			</center>
        </div>
	  </div>
	  <div class="alert alert-success" id="events-result">Successfully! Please go to the option <a href="view_open_cases.html">View Open Cases</a>
	  </div>
    </div> <!-- /container -->
