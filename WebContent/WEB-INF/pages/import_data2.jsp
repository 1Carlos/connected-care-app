      ...
      <div class="page-header">
        ...
        <div class="jumbotron">
			<center>
				...
				<p><a class="btn btn-primary btn-lg disabled" href="import_data2.html" role="button">Upload File</a></p>
			</center>
		...
		<div class="alert alert-success" id="events-result">All records were imported.
		</div>
		<div class="alert alert-danger" id="events-result">The file is not consistent. Please upload the correct file.
		</div>
		<!-- jmartinez table imported -->
