...
import javax.persistence.Table;
	...
	@Column(name="PROGRESS_NOTES_DATE")
	private Date progressNotesDate;
	...
	public Date getProgressNotesDate() {
		return progressNotesDate;
	}

	public void setProgressNotesDate(Date progressNotesDate) {
		this.progressNotesDate = progressNotesDate;
	}
